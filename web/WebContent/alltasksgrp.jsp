                ...
                <div class="card mask-custom">
                    <div class="card-body p-4 text-white">
                        ...
                        <div class="mb-4">
                            ...
                            if (id == ownerid) {
                            %>
                            <a href="addtaskgrp.jsp" class="btn btn-success">Add Task</a>
                            <%
                            }
                            %>
                        </div>
                        <table class="table text-white mb-0" style="background-color: aliceblue">
                            ...
                            <tbody>
                                <%
                                for (taskgrp tasker : completedtasks) {
                                %>
                                <tr class="fw-normal" style="color: rgb(43, 42, 42);">
                                    ...
                                    %>
                                    <td>
                                        <a href="deletegrouptask?idtask=<%= tasker.getId() %>" class="btn btn-danger btn-sm" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                    <%
                                    }
                                    %>
