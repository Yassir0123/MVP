                    ...
                    <div class="card-body p-4 text-white">
                        ...
                        if (counttasks != 0) {
                            ...
                            <div class="alert alert-danger" role="alert">
                                Attention ! Vous avez <%= counttasks %> tâches incomplètes, veuillez les gérer au niveau de <a href="undonegrptask.jsp?ownerid=<%= ownerid %>&idgrp=<%= grpid %>&passphrase=<%= passphrase %>" class="alert-link">tâches non terminées</a>.
                            </div>
                            <%
                        }
                        %>
                        <table class="table text-white mb-0" style="background-color: aliceblue">
                            ...
                            <tbody>
                                <%
                                for (taskgrp tasker : currenttasks) {
                                %>
