                ...
                <div class="card mask-custom">
                    <div class="card-body p-4 text-white">
                        <div class="text-center pt-3 pb-2">
                            ...
                            <h2 class="my-4">Modifier une tâche de groupe</h2>
                        </div>
                        <%
                        ...
                        try {
                            ...
                            String v[] = request.getParameter("datedebut").split("-");
                            int yy = Integer.parseInt(v[0]);
                            int mm = Integer.parseInt(v[1]);
                            int dd = Integer.parseInt(v[2]);
                            LocalDate loc = LocalDate.of(yy, mm, dd);
                            java.sql.Date db = Date.valueOf(loc);
                            String r[] = request.getParameter("datefin").split("-");
                            int yr = Integer.parseInt(r[0]);
                            int mr = Integer.parseInt(r[1]);
                            int dr = Integer.parseInt(r[2]);
                            LocalDate locs = LocalDate.of(yr, mr, dr);
                            java.sql.Date df = Date.valueOf(locs);
                            int status = 0;
                            em.getTransaction().commit();
                        %>
                        <form method="post" action="modifygrouptask">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="idtask" name="idtask" value="<%= idtask %>" readonly="readonly" style="background-color: #e9ecef;" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="datedebut" name="datedebut" value="<%= db %>" required>
                            </div>
                            <div class="form-group">
                                <label for="datefin">Date Fin</label>
                                <input type="date" class="form-control" id="datefin" name="datefin" value="<%= df %>" required>
                            </div>
                            <div class="form-group">
                                <label for="prioriter">Prioriter</label>
                                <select class="form-select" id="prioriter" name="prioriter">
                                    <%
                                    for (category c : cat) {
                                    %>
