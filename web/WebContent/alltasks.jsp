    ...
    if(sess.getAttribute("access") == null) {
        ...
        if(sess.getAttribute("access").equals("0")) {
            ...
            try {
                ...
                List<task> completedtasks = em.createQuery("select t from task t where t.status=1 and t.id_user.id=:id").setParameter("id",id).getResultList();
                ...
                <div class="card mask-custom">
                    <div class="card-body p-4 text-white">
                        ...
                        <table class="table text-white mb-0" style="background-color: aliceblue">
                            ...
                            <tbody>
                                <% for(task tasker : completedtasks) { %>
