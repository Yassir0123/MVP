...
<body class="gradient-custom-2">
    ...
    if (idTaskStr == null || idTaskStr.trim().isEmpty()) {
        ...
        try {
            ...
            List<action> actions = em.createQuery("SELECT a FROM action a WHERE a.id_task.id = :id", action.class)
                                     .setParameter("id", id)
                                     .getResultList();
                        ...
                        <table class="table text-white mb-0" style="background-color: aliceblue">
                            ...
                            <tbody>
                                ...
                                <tr class="fw-normal" style="color: rgb(43, 42, 42);">
                                    ...
                                    <td>
                                        <a href="modifyaction.jsp?idtask=<%= action.getId() %>&description=<%= action.getDescription() %>" class="btn btn-primary btn-sm" title="Modify"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="deleteaction?idt=<%= action.getId() %>" class="btn btn-danger btn-sm" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                <%
                                }
