...
<%@ page import="tasksentities.taskwithname" %>
                ...
                <div class="card mask-custom">
                    <div class="card-body p-4 text-white">
                        ...
                        <table class="table text-white mb-0" style="background-color: aliceblue">
                            ...
                            <tbody>
                                <% for(task tasker : uncompletedtasks) { %>
                                    <tr class="fw-normal" style="color: rgb(43, 42, 42);">
                                        ...
                                        <td>
                                            <a href="modifytask?idtask=<%= tasker.getId() %>&title=<%= tasker.getTitle() %>&description=<%= tasker.getDescription() %>&datedebut=<%= tasker.getDate_debut() %>&datefin=<%= tasker.getDate_fin() %>" class="btn btn-primary btn-sm" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="deletesingletask?idtask=<%= tasker.getId() %>" class="btn btn-success btn-sm" title="Validate"><i class="fas fa-check"></i></a>
